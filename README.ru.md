...
- **Панель руководства** — мастер создания учения (4 шага), режим «всевидящего», конструктор тактических задач, редактор системы управления, анализ местности, редактор типов подразделений, журнал отладки
...
- **Самообучение словаря** — межсессионная кластеризация, ИИ-оценка, утверждение оператором, горячая перезагрузка `order_phrasebook.toml`
...
| **Монитор** | Режим «всевидящего»; журнал подразделений; журнал отладки; **ввод вводных** |
...
| **Эффекты** | Постановка зональных факторов (дымовая завеса, туман, пожар, хим. облако) |
| **Обучение** | Анализ словаря; утверждение/отклонение предложений; горячая перезагрузка |
